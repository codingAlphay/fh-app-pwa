  ...
  return (        
    <div className='flex justify-between'>
      <ul className='mt-8 ml-10'>
        ...
        <Link href={'/bguide'}>
          <li className={listClass}><img src="/icons/menuicons/guide.svg" alt="Beginner's Guide Icon" className='col-span-2'/><span className={`col-span-8 ${path == "/bguide" && 'text-green'}`}>{data["LBL_BGUIDE"]}</span></li>
        </Link>
        <Link href={'/oeh'}>
          <li className={listClass}><img src="/icons/menuicons/association.svg" alt="Student's Association Icon" className='col-span-2'/><span className={`col-span-8 ${path == "/oeh" && 'text-green'}`}>{data["LBL_OEH"]}</span></li>
        </Link>
        <Link href={'/grades'}>
